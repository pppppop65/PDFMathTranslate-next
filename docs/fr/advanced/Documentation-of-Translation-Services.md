...
Nous avons fourni un tableau détaillé des [variables d'environnement](https://chatgpt.com/share/6734a83d-9d48-800e-8a46-f57ca6e8bcb4) requises pour chaque service de traduction. Assurez-vous de les configurer avant d'utiliser le service correspondant.
...
| **Tencent**          | `tencent`      | `TENCENTCLOUD_SECRET_ID`, `TENCENTCLOUD_SECRET_KEY`                   | `[Votre ID]`, `[Votre clé]`                                | Voir [Tencent](https://www.tencentcloud.com/products/tmt?from_qcintl=122110104)                                                                                                                                             |
