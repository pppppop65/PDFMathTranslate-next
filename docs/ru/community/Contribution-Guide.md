...
Спасибо за ваш интерес к этому проекту! Прежде чем начать вносить вклад, пожалуйста, уделите немного времени, чтобы прочитать следующие рекомендации, чтобы ваш вклад мог быть легко принят.
...
4. Зафиксируйте ваш код:
   ```bash
   git add .
   git commit -m "<semantic commit message>"
   ```
5. Отправьте в ваш репозиторий: `git push origin feature/<feature-name>`.
...
>
> Ресурсные файлы для версии 2.0 доступны в [BabelDOC](https://github.com/funstory-ai/BabelDOC). Код для загрузки связанных ресурсов находится в BabelDOC. Если вы хотите добавить новые ресурсные файлы, пожалуйста, свяжитесь с сопровождающим BabelDOC по адресу aw@funstory.ai.
...
> [!NOTE]
>
> Этот проект не предназначен для поддержки движков перевода с RPS (запросов в секунду) менее 4. Пожалуйста, не предлагайте поддержку для таких движков.
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com) спонсирует ежемесячные Pro-коды для активных участников этого проекта. Подробности смотрите в: [BabelDOC/PDFMathTranslate Contributor Reward Rules](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
