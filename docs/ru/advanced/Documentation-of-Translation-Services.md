...
Вы можете подтвердить доступные службы перевода и их использование, напечатав сообщение справки в командной строке.
...
Для больших языковых моделей, совместимых с API OpenAI, но не перечисленных в таблице выше, вы можете установить переменные окружения, используя тот же метод, что и для OpenAI в таблице.
