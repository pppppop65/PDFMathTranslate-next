...
| -------------------- | -------------- | --------------------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Google (По умолчанию)** | `google`       | Нет                                                                  | N/A                                                      | Нет                                                                                                                                                                                                                       |
...
| **ModelScope**       | `ModelScope`   | `MODELSCOPE_API_KEY`, `MODELSCOPE_MODEL`                              | `[Your Key]`, `Qwen/Qwen2.5-Coder-32B-Instruct`          | См. [ModelScope](https://www.modelscope.cn/docs/model-service/API-Inference/intro)                                                                                                                                         |
| **Silicon**          | `silicon`      | `SILICON_API_KEY`, `SILICON_MODEL`                                    | `[Your Key]`, `Qwen/Qwen2.5-7B-Instruct`                 | См. [SiliconCloud](https://docs.siliconflow.cn/quickstart)                                                                                                                                                                 |
...
| **Ali Qwen Translation** | `qwen-mt`  | `ALI_MODEL`, `ALI_API_KEY`, `ALI_DOMAINS`                             | `qwen-mt-turbo`, `[Your Key]`, `scientific paper`        | Традиционный китайский пока не поддерживается, текст будет переведён на упрощённый китайский. Подробнее см. [Qwen MT](https://bailian.console.aliyun.com/?spm=5176.28197581.0.0.72e329a4HRxe99#/model-market/detail/qwen-mt-turbo) |

Для больших языковых моделей, совместимых с API OpenAI, но не перечисленных в таблице выше, вы можете задать переменные среды, используя тот же метод, что и для OpenAI в таблице.
