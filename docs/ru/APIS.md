...
Поскольку `pdf2zh` является установленным модулем в Python, мы предоставляем два метода, которые могут быть вызваны другими программами в любых скриптах на Python.
...
2. Использование HTTP-протоколов следующим образом:
   ...
   - Прерывание задачи и её удаление (если выполняется)
     ```bash
