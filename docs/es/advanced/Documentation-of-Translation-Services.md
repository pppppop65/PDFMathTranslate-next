...
| **DeepL**            | `deepl`        | `DEEPL_AUTH_KEY`                                                      | `[Your Key]`                                             | Ver [DeepL](https://support.deepl.com/hc/en-us/articles/360020695820-API-Key-for-DeepL-s-API)                                                                                                                              |
...
| **Silicon**          | `silicon`      | `SILICON_API_KEY`, `SILICON_MODEL`                                    | `[Your Key]`, `Qwen/Qwen2.5-7B-Instruct`                 | Consulta [SiliconCloud](https://docs.siliconflow.cn/quickstart)                                                                                                                                                                 |
...
| **Tencent**          | `tencent`      | `TENCENTCLOUD_SECRET_ID`, `TENCENTCLOUD_SECRET_KEY`                   | `[Tu ID]`, `[Tu Clave]`                                | Ver [Tencent](https://www.tencentcloud.com/products/tmt?from_qcintl=122110104)                                                                                                                                             |
| **Dify**             | `dify`         | `DIFY_API_URL`, `DIFY_API_KEY`                                        | `[Tu URL de DIFY]`, `[Tu Clave]`                          | Consulta [Dify](https://github.com/langgenius/dify), Tres variables, lang_out, lang_in y text, deben estar definidas en la entrada del flujo de trabajo de Dify.                                                                                  |
| **AnythingLLM**      | `anythingllm`  | `AnythingLLM_URL`, `AnythingLLM_APIKEY`                               | `[Your AnythingLLM URL]`, `[Your Key]`                   | Ver [anything-llm](https://github.com/Mintplex-Labs/anything-llm)                                                                                                                                                          |
