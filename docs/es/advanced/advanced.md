...
- [Soporte del glosario](#soporte-del-glosario)
...
| `--<Services>`                  | Usar [**servicio específico**](./Documentation-de-servicios-de-traducción.md) para traducción | `pdf2zh example.pdf --openai`<br>`pdf2zh example.pdf --deepseek`                                                     |
...
| `--no-auto-extract-glossary`    | Desactivar extracción automática del glosario                                         | `pdf2zh example.pdf --no-auto-extract-glossary`                                                                      |
| `--primary-font-family`         | Sobrescribe la familia de fuentes principal para el texto traducido. Opciones: 'serif' para fuentes serif, 'sans-serif' para fuentes sans-serif, 'script' para fuentes script/cursivas. Si no se especifica, utiliza selección automática de fuentes basada en las propiedades del texto original. | `pdf2zh example.pdf --primary-font-family serif` |
...
| `--dual-translate-first`        | En modo PDF dual, colocar primero la página traducida                                          | `pdf2zh example.pdf --dual-translate-first`                                                                                            |
...
| `--disable-gui-sensitive-input` | Desactivar entrada sensible en la GUI  | `pdf2zh --gui --disable-gui-sensitive-input`    |
...
>
> Cuando se modifica el mismo parámetro utilizando diferentes métodos, el software aplicará los cambios según el orden de prioridad a continuación.
>
...
Cuando se utiliza Autenticación y página de bienvenida para especificar qué usuario debe usar la interfaz web y personalizar la página de inicio de sesión:
...
PDFMathTranslate soporta la tabla de glosario. El archivo de la tabla de glosario debe ser un archivo `csv`.
