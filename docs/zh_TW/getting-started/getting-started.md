...
1. [**Windows EXE**](./如何安裝_winexe.md) <small>推薦用於 Windows</small>
2. [**Docker**](./如何安裝_docker.md) <small>推薦用於 Linux</small>
3. [**uv** (a Python package manager)](./如何安裝_uv.md) <small>推薦用於 macOS</small>
