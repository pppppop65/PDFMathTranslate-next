...
* [Google 翻譯](https://cloud.google.com/translate/docs)
...
* [智譜](https://bigmodel.cn/)
* [深度求索](https://api-docs.deepseek.com/)

#### 使用不同服務進行翻譯

我們提供了每項翻譯服務所需的[環境變數](https://chatgpt.com/share/6734a83d-9d48-800e-8a46-f57ca6e8bcb4)詳細表格。請在使用相應服務前確保已設定這些變數。

| **翻譯器**       | **服務**    | **環境變數**                                             | **預設值**                                       | **備註**                                                                                                                                                                                                                  |
| -------------------- | -------------- | --------------------------------------------------------------------- | -------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Google (預設)** | `google`       | 無                                                                  | 不適用                                                      | 無                                                                                                                                                                                                                       |
| **Bing**             | `bing`         | 無                                                                  | 不適用                                                      | 無                                                                                                                                                                                                                       |
...
| **Zhipu**            | `zhipu`        | `ZHIPU_API_KEY`, `ZHIPU_MODEL`                                        | `[您的金鑰]`, `glm-4-flash`                              | 參閱 [Zhipu](https://open.bigmodel.cn/dev/api/thirdparty-frame/openai-sdk)                                                                                                                                                  |
| **ModelScope**       | `ModelScope`   | `MODELSCOPE_API_KEY`, `MODELSCOPE_MODEL`                              | `[Your Key]`, `Qwen/Qwen2.5-Coder-32B-Instruct`          | 參見 [ModelScope](https://www.modelscope.cn/docs/model-service/API-Inference/intro)                                                                                                                                         |
| **矽智雲**          | `silicon`      | `SILICON_API_KEY`, `SILICON_MODEL`                                    | `[您的金鑰]`, `Qwen/Qwen2.5-7B-Instruct`                 | 參閱 [SiliconCloud](https://docs.siliconflow.cn/quickstart)                                                                                                                                                                 |
| **Gemini**           | `gemini`       | `GEMINI_API_KEY`, `GEMINI_MODEL`                                      | `[您的金鑰]`, `gemini-1.5-flash`                         | 參閱 [Gemini](https://ai.google.dev/gemini-api/docs/openai)                                                                                                                                                                 |
| **Azure**            | `azure`        | `AZURE_ENDPOINT`, `AZURE_API_KEY`                                     | `https://api.translator.azure.cn`, `[您的金鑰]`          | 參閱 [Azure](https://docs.azure.cn/en-us/ai-services/translator/text-translation-overview)                                                                                                                                  |
| **騰訊**          | `tencent`      | `TENCENTCLOUD_SECRET_ID`, `TENCENTCLOUD_SECRET_KEY`                   | `[您的ID]`, `[您的金鑰]`                                | 參閱[騰訊](https://www.tencentcloud.com/products/tmt?from_qcintl=122110104)                                                                                                                                             |
| **Dify**             | `dify`         | `DIFY_API_URL`, `DIFY_API_KEY`                                        | `[您的 DIFY URL]`, `[您的金鑰]`                          | 參見 [Dify](https://github.com/langgenius/dify)，需在 Dify 的工作流程輸入中定義三個變量：lang_out、lang_in 和 text。                                                                                  |
...
| **Groq**             | `groq`         | `GROQ_API_KEY`, `GROQ_MODEL`                                          | `[您的 GROQ_API_KEY]`, `llama-3-3-70b-versatile`         | 參閱 [Groq](https://console.groq.com/docs/models)                                                                                                                                                                           |
| **DeepSeek**         | `deepseek`     | `DEEPSEEK_API_KEY`, `DEEPSEEK_MODEL`                                  | `[您的 DEEPSEEK_API_KEY]`, `deepseek-chat`               | 參閱 [DeepSeek](https://www.deepseek.com/)                                                                                                                                                                                  |
| **OpenAI-Liked**     | `openailiked`  | `OPENAILIKED_BASE_URL`, `OPENAILIKED_API_KEY`, `OPENAILIKED_MODEL`    | `url`, `[Your Key]`, `model name`                        | 無                                                                                                                                                                                                                       |
| **阿里通義翻譯** | `qwen-mt`  | `ALI_MODEL`, `ALI_API_KEY`, `ALI_DOMAINS`                             | `qwen-mt-turbo`, `[您的密鑰]`, `scientific paper`        | 目前尚未支援繁體中文，將會翻譯為簡體中文。更多資訊請參閱 [Qwen MT](https://bailian.console.aliyun.com/?spm=5176.28197581.0.0.72e329a4HRxe99#/model-market/detail/qwen-mt-turbo) |

對於與 OpenAI API 相容但未在上表中列出的大型語言模型，您可以按照表格中針對 OpenAI 所述的方法設置環境變量。
