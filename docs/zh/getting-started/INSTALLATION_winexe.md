[**快速开始**](./getting-started.md) > **如何安装** > **Windows EXE** _(current)_
...
***步骤 4*** | 双击 exe 文件后终端窗口将弹出。约半分钟到一分钟后，默认浏览器会自动打开网页。若未自动跳转，可尝试手动访问 `http://localhost:7860/`。

> [!NOTE]
>
> 如果您在使用 WebUI 过程中遇到任何问题，请参考[此网页](./USAGE_webui.md)。
