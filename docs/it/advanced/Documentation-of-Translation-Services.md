...
Abbiamo fornito una tabella dettagliata sulle variabili d'ambiente richieste per ciascun [servizio di traduzione](https://chatgpt.com/share/6734a83d-9d48-800e-8a46-f57ca6e8bcb4). Assicurati di impostarle prima di utilizzare il rispettivo servizio.
...
| **Dify**             | `dify`         | `DIFY_API_URL`, `DIFY_API_KEY`                                        | `[Il tuo URL DIFY]`, `[La tua chiave]`                          | Vedi [Dify](https://github.com/langgenius/dify), Tre variabili, lang_out, lang_in e text, devono essere definite nell'input del flusso di lavoro di Dify.                                                                                  |
