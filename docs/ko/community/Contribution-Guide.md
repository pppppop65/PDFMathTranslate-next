...
> [!CAUTION]
>
> 현재 프로젝트 관리자들은 문서 국제화 자동화를 연구 중입니다. 따라서 문서 국제화/번역과 관련된 PR 은 받아들여지지 않을 것입니다!
>
...
5. 기여 문서 작성 시 영어 이외의 언어로 문서를 변경하는 경우
6. PDF 파일 수정이 필요한 PR
...
- `main` 브랜치에서 포크 (fork) 를 생성하고, 포크한 브랜치에서 개발을 진행해 주세요.
   ...
   - PR 이 자동화된 검사를 통과하지 못하는 경우 (`checks failed` 및 빨간색 엑스 표시로 표시됨), 해당 `details`를 확인하고 제출 내용을 수정하여 새로운 PR 이 모든 검사를 통과할 수 있도록 해 주세요.
...
<h4 id="doctypo">8. 문서 포맷팅</h4>

- `README.md` 서식은 [중국어 문서 작성 가이드라인](https://github.com/sparanoid/chinese-copywriting-guidelines)을 따르세요.
...
> [!TIP]
>
> [Immersive Translate](https://immersivetranslate.com)는 이 프로젝트에 활발히 기여하는 기여자들을 위해 매월 Pro 멤버십 코드를 후원합니다. 자세한 내용은 다음을 참조하세요: [BabelDOC/PDFMathTranslate 기여자 보상 규칙](https://funstory-ai.github.io/BabelDOC/CONTRIBUTOR_REWARD/)
