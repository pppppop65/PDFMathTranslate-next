...
| `--lang-in`                      | The code of source language. (ISO 639-1 code)                                                                                                                                                                                          | `pdf2zh example.pdf --lang-in en`                                                                                    |
| `--lang-out`                     | The code of target language. (ISO 639-1 code)                                                                                                                                                                                          | `pdf2zh example.pdf --lang-out zh-CN`                                                                                |
...
| `--primary-font-family`          | Override primary font family for translated text. <br>Options: `serif`, `sans-serif`, `script`. If not specified, uses automatic font selection based on original text properties.                                                     | `pdf2zh example.pdf --primary-font-family serif`                                                                     |
...
| `--formular-font-pattern`        | Font pattern to identify formula text (regular expression)                                                                                                                                                                             | `pdf2zh example.pdf --formular-font-pattern "(MS.*)"`                                                                |
| `--formular-char-pattern`        | Character pattern to identify formula text (regular expression)                                                                                                                                                                        | `pdf2zh example.pdf --formular-char-pattern "(MS.*)"`                                                                |
| `--split-short-line`             | Force split short line into different paragraphs                                                                                                                                                                                       | `pdf2zh example.pdf --split-short-line`                                                                              |
| `--short-line-split-factor`      | Split threshold factor for short lines (decimal between 0 and 1)                                                                                                                                                                       |                                                                                                                      |
| `--skip-clean`                   | Skip PDF cleaning step                                                                                                                                                                                                                 | `pdf2zh example.pdf --skip-clean`                                                                                    |
| `--dual-translate-first`         | Prioritize translation pages in dual PDF mode.                                                                                                                                                                                         | `pdf2zh example.pdf --dual-translate-first`                                                                          |
...
| `--watermark-output-mode`        | Watermark output mode for PDF files. <br> Options: `watermarked`, `no_watermark`, `both`                                                                                                                                               | `pdf2zh example.pdf --watermark-output-mode "no_watermark"`                                                          |
...
| `--auto-enable-ocr-workaround`   | Enable automatic OCR workaround. If a document is detected as heavily scanned, this will attempt to enable OCR processing and skip further scan detection. See documentation for details. Options: `True`, `False` (default: False)    | `pdf2zh example.pdf --auto-enable-ocr-workaround True`                                                               |
...
It is highly recommended to create your configuration file in the following way:

1. Install `pdf2zh` locally;
2. Use the GUI to translate a file (simply click the translate button);
3. By default, the GUI will save the configuration to `~/.config/pdf2zh/config.v3.toml` when you click the translate button. After completing step 2, you can copy and modify the configuration file from this directory.
